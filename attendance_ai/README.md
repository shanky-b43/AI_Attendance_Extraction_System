# AI Attendance Recognition System
...
1. Place your scanned attendance sheets in `input/pdfs/` or `input/images/`.
2. Run the main pipeline:
   ```bash
   python src/main.py
   ```
3. Check `output/excel/attendance_result.xlsx` for the results.
